...
$(document).ready(function() {
	...
	profile_images.checkFileType({
        ...
        error: function(this_obj) {
            ...
            profile_errors.text('Убедитесь, что вы выбрали файлы: jpg, jpeg, или png');
        }
	});
	...
	user_passport.checkFileType({
        ...
        error: function() {
            ...
            $(".passport_upload span")
            	.text('Убедитесь, что вы выбрали файлы: jpg, jpeg, png, pdf')
	...
	function isOthersFilled() {
		...
		if (wished_city.val() === 'Без разницы') {
			return false;
		}
	...
	*/
	...
	btn_step1.click(function() {
		...
		if (isFieldsFilled(inputs_step1, 20)) // if step-1 validation is TRUE 
		{ 
		...
		{ 
			...
			warning_step1.text("Пожалуйста, заполните все поля");
		}
	...
	btn_step2.click(function() {
		...
		{ 
			...
			warning_step2.text("Пожалуйста, заполните все поля");
		}
	...
	btn_submit.click(function() {
		...
		{ 
			warning_step3.text("Пожалуйста, заполните все поля");
		}
